...
const cars_data = (manufacturer, model_name, ...restOfData) => {
    ...
    if (restOfData.length > 0) {
        console.log(`The other data that you provided us is : ${restOfData.join(", ")}`);
    }
};
// using the function without any additional data
cars_data("suziuki", "WagonR");
// Using the function with some additional data
cars_data("Honda", "Civic", "Color = Red", "Model = 2020");
